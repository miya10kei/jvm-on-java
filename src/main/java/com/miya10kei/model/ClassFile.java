...
public class ClassFile {
  ...
  public ClassFile(DataInput raw) throws IOException {
    ...
    this.thisClass = raw.readUnsignedShort();
    this.superClass = raw.readUnsignedShort();
    this.interfacesCount = raw.readUnsignedShort();
    this.interfaces = new int[this.interfacesCount];
    for (int i = 0; i < interfacesCount; i++) {
      this.interfaces[i] = raw.readUnsignedShort();
    }
  }
}
